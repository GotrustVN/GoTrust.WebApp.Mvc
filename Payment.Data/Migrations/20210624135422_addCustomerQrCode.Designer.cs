...
namespace Payment.Data.Migrations
{
    ...
    [Migration("20210624135422_addCustomerQrCode")]
    partial class addCustomerQrCode
    {
            ...
            modelBuilder.Entity("Payment.Data.Entities.Bank", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 449, DateTimeKind.Local).AddTicks(1913));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 453, DateTimeKind.Local).AddTicks(394));
            ...
            modelBuilder.Entity("Payment.Data.Entities.CustomerType", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 465, DateTimeKind.Local).AddTicks(1533));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 465, DateTimeKind.Local).AddTicks(1939));
            ...
            modelBuilder.Entity("Payment.Data.Entities.FileImport", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 490, DateTimeKind.Local).AddTicks(488));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 490, DateTimeKind.Local).AddTicks(961));
            ...
            modelBuilder.Entity("Payment.Data.Entities.MasterCategory", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 470, DateTimeKind.Local).AddTicks(2809));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 470, DateTimeKind.Local).AddTicks(3277));
            ...
            modelBuilder.Entity("Payment.Data.Entities.OrderInfor", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 472, DateTimeKind.Local).AddTicks(2581));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 472, DateTimeKind.Local).AddTicks(3424));
            ...
            modelBuilder.Entity("Payment.Data.Entities.OrderStatus", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 473, DateTimeKind.Local).AddTicks(8384));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 473, DateTimeKind.Local).AddTicks(8838));
            ...
            modelBuilder.Entity("Payment.Data.Entities.OrderType", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 475, DateTimeKind.Local).AddTicks(7889));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 475, DateTimeKind.Local).AddTicks(8282));
            ...
            modelBuilder.Entity("Payment.Data.Entities.PaymentLog", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 478, DateTimeKind.Local).AddTicks(6163));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 24, 20, 54, 21, 478, DateTimeKind.Local).AddTicks(6692));

...
namespace Payment.Data.Migrations
{
    ...
    [Migration("20210611180732_InitDb")]
            ...
            modelBuilder.Entity("Payment.Data.Entities.Bank", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 6, 12, 1, 7, 31, 828, DateTimeKind.Local).AddTicks(772));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 12, 1, 7, 31, 831, DateTimeKind.Local).AddTicks(2309));
            ...
            modelBuilder.Entity("Payment.Data.Entities.OrderInfor", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 12, 1, 7, 31, 836, DateTimeKind.Local).AddTicks(5188));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 12, 1, 7, 31, 836, DateTimeKind.Local).AddTicks(5663));
            ...
            modelBuilder.Entity("Payment.Data.Entities.OrderStatus", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 12, 1, 7, 31, 838, DateTimeKind.Local).AddTicks(2618));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 12, 1, 7, 31, 838, DateTimeKind.Local).AddTicks(3114));
            ...
            modelBuilder.Entity("Payment.Data.Entities.OrderType", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 12, 1, 7, 31, 839, DateTimeKind.Local).AddTicks(5779));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 12, 1, 7, 31, 839, DateTimeKind.Local).AddTicks(6096));

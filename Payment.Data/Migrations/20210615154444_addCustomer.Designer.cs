...
namespace Payment.Data.Migrations
{
    ...
    [Migration("20210615154444_addCustomer")]
            ...
            modelBuilder.Entity("Payment.Data.Entities.Bank", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 565, DateTimeKind.Local).AddTicks(7031));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 568, DateTimeKind.Local).AddTicks(9384));
            ...
            modelBuilder.Entity("Payment.Data.Entities.CustomerType", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 574, DateTimeKind.Local).AddTicks(4721));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 574, DateTimeKind.Local).AddTicks(5140));
            ...
            modelBuilder.Entity("Payment.Data.Entities.FileImport", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 592, DateTimeKind.Local).AddTicks(4918));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 592, DateTimeKind.Local).AddTicks(5296));
            ...
            modelBuilder.Entity("Payment.Data.Entities.OrderInfor", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 579, DateTimeKind.Local).AddTicks(1034));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 579, DateTimeKind.Local).AddTicks(1433));
            ...
            modelBuilder.Entity("Payment.Data.Entities.OrderStatus", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 580, DateTimeKind.Local).AddTicks(5086));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 580, DateTimeKind.Local).AddTicks(5449));
            ...
            modelBuilder.Entity("Payment.Data.Entities.OrderType", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 582, DateTimeKind.Local).AddTicks(3662));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 582, DateTimeKind.Local).AddTicks(4017));
            ...
            modelBuilder.Entity("Payment.Data.Entities.PaymentLog", b =>
                {
                    ...
                    b.Property<DateTime>("createdAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 585, DateTimeKind.Local).AddTicks(2971));
                    ...
                    b.Property<DateTime>("lastUpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2021, 6, 15, 22, 44, 43, 585, DateTimeKind.Local).AddTicks(3415));
